...
optical = dict(
    type='BinaryPsfConv',
    feature_size = 3.45e-6 * 12,
    mask_kernel_shape = 3,  
    sensor = "IMX250",
    input_shape = [1, 308 * 8, 257 * 8] ,
    scene2mask = 0.4,
    mask2sensor = 0.001,
    grayscale = True,
...
propagated_args = dict(
    mask2sensor=0.001,
    scene2mask=0.4,
    object_height=13.8e-4,
    sensor = "IMX250",
    single_psf = False,
    grayscale = True,
    input_dim = [1, 1, 3],
    output_dim = [308 * 8, 257 * 8, 1] ,
...
train_pipeline = [
    ...
    dict(type='CenterCrop', crop_size=(1, 1)),
...
model = dict(
    ...
    backbone=dict(type='MobileFaceNet_feature_optical', optical = optical, in_channel=1),
